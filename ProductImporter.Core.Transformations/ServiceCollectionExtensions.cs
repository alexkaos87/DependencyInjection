...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddProductImporterCoreTransformations(this IServiceCollection services)
    {
        return services
            ...
            .AddScoped<INameDecapitaliser, NameDecapitaliser>() // scoped to a single product
            .AddScoped<ICurrencyNormalizer, CurrencyNormalizer>() // scoped to a single product
            ...
            .AddScoped<IReferenceAdder, ReferenceAdder>(); // scoped to a single product
    }
}
